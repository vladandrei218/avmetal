    ...
    return (
        <div className="container my-5">
            ...
            <div className="text-center mb-5">
                <h1 className="modern-underline">Ferestre și Uși Termopan </h1>
            ...
            <section className="mb-5">
                ...
                <div className="row g-3">
                    {FerestreTermopanImages.map((src, i) => (
                        <div className="col-6 col-md-4 col-lg-3" key={i}>
                            <img
                                ...
                                onClick={() => openLightbox(FerestreTermopanImages, i)}
...
export default FerestreTermopan;