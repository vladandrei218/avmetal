    ...
    return (
        <div className="container my-5">
            ...
            <div className="text-center mb-5">
                <h1 className="modern-underline">Automatizări BFT </h1>
            ...
            <section className="mb-5">
                ...
                <div className="row g-3">
                    {AutomatizariBFTImages.map((src, i) => (
                        <div className="col-6 col-md-4 col-lg-3" key={i}>
                            <img
                                ...
                                onClick={() => openLightbox(AutomatizariBFTImages, i)}
...
export default AutomatizariBFT;