...
const portiZincateImages = Object.values(
    import.meta.glob('/src/assets/BALUSTRADE/*.{jpg,jpeg,png,webp}', { eager: true, as: 'url' })
) as string[];



function PortiZincate() {
    ...
    return (
        <div className="container my-5">
            ...
            <div className="text-center mb-5">
                <h1 className="modern-underline">Porți și Garduri Zincate</h1>
                    ...
                    {portiZincateImages.map((src, i) => (
                        <div className="col-6 col-md-4 col-lg-3" key={i}>
                            <img
                                ...
                                onClick={() => openLightbox(portiZincateImages, i)}
