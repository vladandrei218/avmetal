...
const usiGarajImages = Object.values(
    ...
    return (
        <div className="container my-5">
            ...
            <div className="text-center mb-5">
                <h1 className="modern-underline">Uși de Garaj</h1>
                    ...
                    {usiGarajImages.map((src, i) => (
                        <div className="col-6 col-md-4 col-lg-3" key={i}>
                            <img
                                ...
                                onClick={() => openLightbox(usiGarajImages, i)}
